...
interface OpenWeatherService {
    ...
    @GET("v1/forecast?hourly=temperature_2m,precipitation,weather_code,cloud_cover,wind_speed_10m,wind_direction_10m,wind_gusts_10m&wind_speed_unit=kn")
    suspend fun forecast(
        ...
        @Query("models") model: String = "ecmwf_ifs025",
