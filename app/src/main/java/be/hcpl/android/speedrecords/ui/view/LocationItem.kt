            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        ...
                        fontWeight = if ((it.value.windSpeedAt10mMin ?: 0.0) >= 10) FontWeight.Bold else FontWeight.Normal,
                        fontStyle = if ((it.value.windSpeedAt10mMin ?: 0.0) >= 10) FontStyle.Italic else FontStyle.Normal,
                    )
                    Text(
                        text = "max ${it.value.windSpeedAt10mMax?.roundToInt() ?: "-"} kts",
                        fontWeight = if ((it.value.windSpeedAt10mMax ?: 0.0) >= 10) FontWeight.Bold else FontWeight.Normal,
                        fontStyle = if ((it.value.windSpeedAt10mMax ?: 0.0) >= 10) FontStyle.Italic else FontStyle.Normal,
                        )
                }
